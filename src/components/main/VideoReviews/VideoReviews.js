    ...
    return (
        <div className="main-videoreviews">
            ...
            <div className="videoreviews-videos">
                <iframe width="490" height="270" src="https://www.youtube.com/embed/uWAxy1J9aWQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
